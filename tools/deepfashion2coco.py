...
for num in tqdm(range(1, num_images+1)):
    json_name = '/home/test/data/train/annos/' + str(num).zfill(6)+'.json'
    image_name = '/home/test/data/train/image/' + str(num).zfill(6)+'.jpg'
...
json_name = '/home/test/data/train/valid.json'
