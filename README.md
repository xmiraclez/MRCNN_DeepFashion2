 ...
 6. Запуск в режиме inference: 
    ...
    3) Создать <output folder> куда сохранить обработанные изображения
 ...
 7. Мой комментарий: модель конечно еще далека от совершенства, на лицо, например то что она очень упорно путает между собой длинные и короткие рукава, причем выбор делает уверенно судя по скору. Если все нормально с датасетом и пайплайном, то я бы дальше провел аугментации данных для слабых мест модели, а по рукавам отдельно вставил бы модуль бинарной классификации.  
